...
function App() {
  ...
  const competitionKey = selectedCompetition.toLowerCase();
  const HOLE_INFO = competitionKey === 'men' ? MENS_HOLE_INFO : WOMENS_HOLE_INFO;
        ...
        <div className="teams">
          {teams.map((team, teamIndex) => (
            <div key={team.name} className="team-card" style={{ borderColor: team.color }}>
              ...
              {/* Insert your team view code here if needed */}
